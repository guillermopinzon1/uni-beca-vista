            ...
            <div className="space-y-4">
              {historial.map((sesion) => (
                <Card
                  ...
                  onClick={() => sesion.estado.toLowerCase() === 'completado' && verResultados(sesion.id)}
                >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              Iniciado: {format(new Date(sesion.fecha_inicio), "dd/MM/yyyy 'a las' HH:mm")}
                            </span>
                          </div>
                          {sesion.fecha_fin && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                Completado: {format(new Date(sesion.fecha_fin), "dd/MM/yyyy 'a las' HH:mm")}
                              </span>
                            </div>
                          )}
                          {sesion.perfil_dominante && (
                            <div className="flex items-center gap-2">
                              <GraduationCap className="h-4 w-4" />
                              <span className="font-medium text-gray-900">
                                Perfil: {sesion.perfil_dominante}
                              </span>
                            </div>
                          )}
                        </div>
