...
const RenovacionDocumentos = () => {
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Verificación Trimestral</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              La beca Impacto no requiere renovación anual, pero sí verificación automática trimestral
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-semibold text-green-900">Verificación Octubre 2025</h4>
                <Badge className="bg-green-600">✅ Aprobada</Badge>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-1">
                  <p>✅ IAA mínimo: 13.5/20 (Requerido: 12.0)</p>
                  <p>✅ Créditos: 14 inscritos (Mínimo: 12)</p>
                </div>
                <div className="space-y-1">
                  <p>✅ Asistencia mentoría: 100%</p>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-semibold text-blue-900">Próxima Verificación</h4>
                <Badge variant="outline" className="border-blue-300 text-blue-700">
                  30 Nov 2025
                </Badge>
              </div>
              <div className="text-sm text-blue-800">
                <p>La próxima verificación será automática. Asegúrate de mantener:</p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>IAA ≥ 12.0 puntos</li>
                  <li>Mínimo 12 créditos inscritos</li>
                  <li>Asistencia regular a mentoría</li>
                  <li>Sin sanciones disciplinarias</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-3 bg-muted rounded-lg">
                ...
                <h5 className="font-medium">Verificación Automática</h5>
                <p className="text-xs text-muted-foreground">Cada 3 meses</p>
              </div>
              
              <div className="text-center p-3 bg-muted rounded-lg">
                <CheckCircle className="h-8 w-8 mx-auto mb-2 text-green-600" />
                <h5 className="font-medium">3/3 Verificaciones</h5>
                <p className="text-xs text-muted-foreground">Aprobadas en 2025</p>
              </div>
              
              <div className="text-center p-3 bg-muted rounded-lg">
                <AlertTriangle className="h-8 w-8 mx-auto mb-2 text-yellow-600" />
                <h5 className="font-medium">Próxima en 15 días</h5>
